      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2 max-w-3xl mx-auto">
        {shelf.map((b) => {
          ...
          return (
            <div
              key={b.id}
              className="group relative flex items-center gap-2 rounded-2xl border border-indigo-200/70 bg-white/80 hover:bg-white hover:border-indigo-400 hover:shadow-md px-3 py-2.5 transition-all"
            >
              <a
                href={b.url}
                target="_blank"
